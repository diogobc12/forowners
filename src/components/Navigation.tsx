...
export function Navigation({ scrolled }: NavigationProps) {
  ...
  return (
    <nav className={`fixed w-full z-50 transition-all duration-700 p-5 ${
      scrolled ? 'bg-slate-900/90 backdrop-blur-sm shadow-lg mt-6 sm:w-[80%] w-[85%] sm:py-1 py-0 px-1 sm:px-2 rounded-lg' : 'bg-[#050725]' 
    }`}>
